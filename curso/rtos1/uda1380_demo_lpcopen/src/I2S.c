...
//	I2S_IRQCmd(LPC_I2S,I2S_TX_MODE,ENABLE);
	...
	Chip_I2S_Init (UDA1380_I2S_BUS);
	Chip_I2S_TxConfig (UDA1380_I2S_BUS, &i2sAudioFmt, FALSE);
	Chip_I2S_TxStop(UDA1380_I2S_BUS);
	Chip_I2S_DisableMute(UDA1380_I2S_BUS);
	Chip_I2S_TxStart(UDA1380_I2S_BUS);
}
